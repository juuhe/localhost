...
class phpmailerTest extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		if (array_key_exists('mail_cc', $_REQUEST) && (0 < strlen($_REQUEST['mail_cc']))) {
	...
	{
		$this->CheckChanges();
		if (($this->Mail->ContentType == 'text/html') || (0 < strlen($this->Mail->AltBody))) {
			$eol = '<br/>';
			$bullet = '<li>';
			$bullet_start = '<ul>';
			$bullet_end = '</ul>';
